    ...
    <div class="wrap">
        ...
        <div class="header-bottom" style="position:relative; top:20px;">
            <div class="menu">
                ...
                <li class="active"><a href="notify.php">view stock</a></li>
            </div>
            <div class="clear"></div>
        </div>
    </div>
        ...
        <div class="content" style="position:relative; top:20px;">
            <div class=" section group">
                ...
                <form method="post" action=" "
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840; position:absolute; left:70px; top:150px;">Part Name </p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840;   position:absolute; left:230px; top:150px;">Qty </p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    <div class="clear"></div>
                    <tr>
                        <td>
                            <p style="color:#E5B840;   position:absolute; left:290px; top:150px;">Model</p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    <tr>
                        <td>
                            <p style="color:#E5B840;  position:absolute; left:390px; top:150px;">Type</p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    <div class="clear"></div>
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840;  position:absolute; left:660px; top:150px;">Supplier Email </p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840;  position:absolute; left:900px; top:150px;">Supplier Name </p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    <tr style="padding-top:30px;">
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840;  padding-top:800px;"> </p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                </form>
