    ...
    <div class="wrap">
        ...
        <div class="header-bottom" style="position:relative; top:20px;">
            <div class="menu">
                ...
                <li class="active"><a href="viewEmp.php">View Employee</a></li>
            </div>
            <div class="clear"></div>
        </div>
    </div>
                      ...
                      $conn=mysqli_connect("localhost","root","","garage_management_system");
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-sm btn-primary" id="btn-update" style="color:white;"
                                    href="UpdateEmp.php?id=<?php echo $row['EMPID']; ?>">
                                    Update</a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

                            <td> <a class="btn btn-sm btn-danger" id="btn-delete" style="color:white;"
                                    href="functions/delete_dist.php?id=<?php echo $row['EMPID']; ?>"><i
                                        class="fas fa-trash"></i> Delete</a></a></td>
                        </tr>
