    ...
    <div class="wrap">
        ...
        <div class="header-bottom" style="position:relative; top:20px;">
            <div class="menu">
                ...
                <li class="active"><a href="Uassigned.php">Job STATUS</a></li>
            </div>
            <div class="clear"></div>
        </div>
    </div>
                ...
                <table>
                    ...
                    <tbody>
                      ...
                      $conn=mysqli_connect("localhost","root","","garage_management_system");
                        $sql ="SELECT * FROM job where status='in progress'";
                        ...
                        <tr>
                            ...
                            <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-sm btn-primary"
                                    id="btn-update" style="color:white;"
                                    href="UassignedJob.php?id=<?php echo $row['jobId']; ?>">
                                    Update</a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
