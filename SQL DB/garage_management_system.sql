...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2022 at 10:58 AM
...
(26, '03:36:45', '2020-12-09', '09:00:00', '10:00:00', 1, 'HH4502', 1, 'A0026'),
(27, '01:20:21', '2020-12-20', '10:00:00', '11:00:00', 21, 'HT1869', 1, 'A0027'),
(28, '10:31:05', '0000-00-00', '11:00:00', '12:00:00', 0, '', 1, 'A0028');
...
(20, 'ht3941', 'Raigarh', 'kisan kumar', '8995916454', 'kisasn@gmail.com', 'fb0dbd3051227208e0c7362d1bd714af', 'C0020'),
(21, 'HT1869', 'Bhilai Chhattisagarh', 'Arjun Kumar', '6263056778', 'arjun@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'C0021'),
(22, 'KL2345', '', '', '', '', '', ''),
(23, 'KL0000', 'onaparambil', 'mali', '7356507361', 'malu', '933f0172c0445968d5b76c508a2d9879', 'C0023'),
(24, 'KL1111', 'onaparambil', 'ammu', '7736630514', 'ammu@gmail.com', 'e0950e017a3b0a4e19cbefc3b26cc311', 'C0024');
...
(12, 'marriage', '2022-03-01', '2022-03-03', 'in progress', 7, 'LE0012');
...
(23, 5000, 1000, 'E003', 25, 24.875, 2000, 'SA0023', '2020-12-11');
...
ALTER TABLE `customer`
  ADD PRIMARY KEY (`cid`,`plateNo`,`CUSID`),
  ADD KEY `plateNo` (`plateNo`);
...
ALTER TABLE `employee`
  ADD PRIMARY KEY (`eid`,`EMPID`);

--
-- Indexes for table `job`
--
ALTER TABLE `job`
  ADD PRIMARY KEY (`jobId`,`JID`),
  ADD KEY `eid` (`eid`),
  ADD KEY `aid` (`aid`),
  ADD KEY `plateNo` (`plateNo`);
...
--
ALTER TABLE `salary`
  ADD PRIMARY KEY (`salId`,`SALARYID`),
  ADD KEY `eid` (`eid`);
...
--
ALTER TABLE `loyalty_points`
  MODIFY `loyaltyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `salary`
  MODIFY `salId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
