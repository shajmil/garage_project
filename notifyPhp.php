	...
	public function send()
	{
		...
		{	
			while($this->row=mysqli_fetch_array($this->result))
			{
				...
				$this->sid=$this->row[0];
				$this->url = "stockupdate.php?id={$this->sid}";
				...
				echo"<p style='position:absolute; left:1090px; top:{$this->x}px; z-index:99999; font-size:20px; font-family:arvo; color:#E5B840; font-weight:bold; ' ></p>";
				echo"<p style='position:absolute; left:1100px; top:{$this->x}px; z-index:99999; font-size:20px; font-family:arvo; color:white; font-weight:bold; color:white;' ><a href={$this->url } >update</a></p>";
