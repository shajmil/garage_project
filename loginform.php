...
<form method="post" action=" ">
	<table>
		<tr>
		<td style=" position:absolute; top:90%; left:35%;"><input type="text" name="email"  id="email12" placeholder="Username or Email" size="50%"; style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
