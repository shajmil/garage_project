...
$Employee_ID=$_POST['eid'];
       ...
       $sql= "SELECT * FROM salary WHERE eid = '$Employee_ID'";
    //    echo $sql;
      ...
      {?>
<script>
alert('Could not find Employee Id');
    ...
    <div class="wrap">
        <div class="content" style="position:relative; top:20px;>
            ...
            <form method="post" action=" "
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840;">Employee ID : <input style="position:absolute; top:125px; left:320px;"
                                type="text" name='eid' id="eid" onkeyup="setTotal()"
                                value="<?php echo $Employee_ID; ?>  " readonly></p>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840; padding-top:30px;">Basic Salary : <input
                                style="position:absolute; top:175px; left:320px;" type="text" name='amount' id="amount"
                                value="<?php echo $result['amount']; ?>" required="required">
                        </p>
                    </td>
                </tr>
                <div class="clear"></div>
                <tr>
                    <td>
                        <p style="color:#E5B840;  padding-top:30px;"> OT : <input
                                style="position:absolute; top:225px; left:320px;" type="text" name='OT'
                                required="required"></p>
                    </td>
                </tr>
                <div class="clear"></div>
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840;  padding-top:30px;"> Bonus : <input
                                style="position:absolute; top:280px; left:320px;" type="text" name='bonus'
                                required="required"></p>
                    </td>
                </tr>
                <div class="clear"></div>
                ...
                <tr>
                    <td><input type='button' value='Clear'
                            style='width:150px; height:30px; border-radius:45px; border-style:none; font-family:avro; font-size:16px; position:absolute; left:720px; top:280px;'>
                    </td>
                </tr>
                <div class="clear"></div>
                <!--tr>
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840;  padding-top:50px;"> Salary ID</p>
                    </td>
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840;  position:absolute; top:355px; left:230px;">Employee Name
                    </td>
                </tr>
                <div class="clear"></div>
                <div class="clear"></div>
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840;  position:absolute; top:355px; left:480px;">
                            Basic Salary
                    </td>
                </tr>
                <div class="clear"></div>
                ...
                <tr>
                    <td>
                        <p style="color:#E5B840;  position:absolute; top:355px; left:680px;">EPF
                    </td>
                </tr>
                <div class="clear"></div>
                <div class="clear"></div>
                <tr>
                    <td>
                        <p style="color:#E5B840;  position:absolute; top:355px; left:860px;">ETF
                    </td>
                </tr>
                <div class="clear"></div>
                <div class="clear"></div>
...
document.getElementById('eid').value = <?php echo $Employee_ID ?>;
</script>
