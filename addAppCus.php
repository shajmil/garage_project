    ...
    <div class="wrap">
        <div class="content" style="position:relative; top:20px;">
            <div class="section group">
                ...
                <form method="POST" action=" "
                    style="font-size:20px; font-family:arvo; font-weight:bold; padding-top:600px; padding-left:60px; color:#E5B840;">
                    <tr>
                        <td>
                            <p style="color:#E5B840; position:absolute; top:125px; left:70px;">Plate Number : <input
                                    style="position:absolute; top:5px; left:250px;" type="text" name='plate'></p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840; position:absolute; top:125px; left:750px;">Plate Number :</p>
                        </td>
                    </tr>
                    <div class="clear"></div>
                    ...
                    <tr>
                        <td>
                            <p style="color:#E5B840;  position:absolute; top:170px; left:70px;">Date : <input
                                    style="position:absolute; top:5px; left:250px;" type="date" placeholder="YY-MM-DD"
                                    name='d'>
                            <div class="clear"></div>
                    </tr>
                    <tr>
                        <td>
                            <p style="color:#E5B840;  position:absolute; top:170px; left:750px;">Date :
                            <div class="clear"></div>
                    </tr>

                    <tr>
                        <td><input type='submit' value='Submit' name='check'
                                style='width:100px; height:30px; border-radius:45px; border-style:none; font-family:avro; font-size:16px; position:absolute; left:500px; top:170px;'>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <p style="color:#E5B840;  padding-top:30px; position:absolute; top:200px; left:750px;">
                                Availability of Time : </p>
                        </td>
                            ...
                            <ul>
                                <li><a href="#" class="facebook">
                                        <span class="icon"> &nbsp;</span> <span
                                            class="inner"><strong>Facebook</strong></span>
                                    </a></li>
                                <li><a href="#" class="twitter">
                                        <span class="icon"> &nbsp;</span> <span
                                            class="inner"><strong>Twitter</strong></span>
                                    </a></li>
                                <!--  <li><a href="#" class="rss">
