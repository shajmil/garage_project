...
<div style="font-size:2em; color:#E5B840; padding:255px 20px; font-family: 'bebas_neueregular'; "> 
	...
	<table>
		...
		<tr>
		<td style=" position:absolute; top:160%; left:70%;"><input type="submit" name="signupbutton" value="Sign Up" style="background-color:grey; color:black; width:100px; height:30px; border-radius:45px; border-style:none;"></td>
		</tr>
					...
					<h3>Location</h3>
					       <ul>
						  	  ...
						  	  <li>Jaistambh,</li>
						  	   <li>Chowk,Raipur</li>
							   <li>Chhattisgarh,</li>
						  	 <li><span>E-mail:</span>project@gmail.com</li>
