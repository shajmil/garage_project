...
<body>
    ...
    <div class="wrap">
        ...
        <div class="header-bottom" style="position:relative; top:20px;">
            <div class="menu">
                ...
                <li><a href="viewcus.php">Customer List</a></li>
    ...
    <div class="wrap">
        ...
        <div class="content" style="position:relative; top:20px;>
            ...
            <p
                style="font-size:25px; font-family:arvo; font-weight:bold; padding-top:30px; padding-left:60px; color:#E5B840; position:absolute; left:500px;">
                SEARCH VEHICLE</p>

            <form method="post" action=" ">
                <p style="color:#E5B840; font-family:arvo; font-size:20px; position:absolute; top:180px; left:560px;">
                    Plate Number :
                    ...
                    <input type='submit' value='Search' name='sveh'
                        style='width:80px; height:25px; border-radius:45px; border-style:none; font-family:avro; font-size:16px; position:absolute; left:300px; top:4px;'>
                </p>
            </form>

            <p
                style="font-size:20px; font-family:arvo; font-weight:bold; padding-top:30px; padding-bottom:100px; padding-left:60px; color:#E5B840; position:absolute; left:500px; top:210px;">
                Vehicle Availability : </p>
            <p
                style="font-size:20px; font-family:arvo; font-weight:bold; padding-top:30px; padding-bottom:50px; padding-left:60px; color:#E5B840;">
                Plate Number</p>
